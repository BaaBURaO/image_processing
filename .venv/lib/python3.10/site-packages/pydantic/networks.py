...
m = MyDatabaseModel(db='postgres://user:pass@localhost:5431/foobar')
print(m.db)
#> postgres://user:pass@localhost:5431/foobar

try:
    MyDatabaseModel(db='postgres://user:pass@localhost:5431')
except ValidationError as e:
    print(e)
    '''
    ...
    assert (None)
     +  where None = MultiHostUrl('postgres://user:pass@localhost:5431').path [type=assertion_error, input_value='postgres://user:pass@localhost:5431', input_type=str]
    '''
```
"""
